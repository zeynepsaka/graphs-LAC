...
public abstract class PageCursor implements AutoCloseable {
    ...
    public static float[] diskPagesRel = new float[1];
    public static float[] diskPagesNode = new float[1];
    public static float[] diskPagesProp = new float[1];

    public static int nodeMiss = 0;
    public static int relMiss = 0;
    public static int otherMiss = 0;
